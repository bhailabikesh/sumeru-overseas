                    ...
                    <div class="text-center banner__heading">
                        ...
                        <nav aria-label="breadcrumb" class="mt-4">
                            <ol class="bg-transparent breadcrumb banner__breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Procedure Details</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="single-well last-part">
                                ...
                                <h5>Periodic Progress Report</h5>
                                <p>
                                ...
                                <ul class="marker-list">
                                    <li>
                                        <strong>Selection:</strong> Always an updated data bank is maintained with processed information on workers: professionals, skilled, semiskilled, unskilled labour for ready consideration. Regular trade-tests and interviews are conducted to determine grade, qualifications, possession of certificates, license, training, experience etc. At least 50% of more than the required number of candidates is primarily selected to ensure most appropriate final recruitment. A thousand personnel in different categories can well be selected in a week, including trade tests.
                                    </li>
                                    ...
                                    <li>
                                        <strong>Issue of Passport: </strong>Regular and correct passport is obviously important for personnel going to obtain it. But with instruction from the government to the passport authority for quick action in this case, on special recommendation, a passport may be issued with in 48 hours.
                                    </li>

                                    <li>
                                        <strong>Medical Check Up: </strong>A medical board, including psychiatrists, conducts check-up of selected candidates. Candidates are sent to the doctor / hospital / clinic nominated by the embassy of the respective country which is approved by the Nepal Government medical board as advised by the employer, for the examination.
                                    </li>

                                    <li>
                                        <strong>Execution of Contract: </strong>We will arrange for the execution of contract between the employer and the employees on behalf of the employer on receipt of due authorization from the esteemed employer.
                                    </li>
                                    
                                    <li>
                                        <strong>Endorsement of VISA / NOC: </strong>We will arranges for obtaining Visa / NOC from concerned embassy as soon as possible on receipt of authenticated Power of Attorney from the employer / Principal.
                                    </li>
                                    
                                    <li>
                                        <strong>Govt. Clearance / Immigration Clearance: </strong>The Visa / NOC received, by our own efforts obtains immigration clearance for the expatriate from the concerned authorities at the earlier.
                                    </li>
                                    
                                    <li>
                                        <strong>Ticketing: </strong>If Pre-paid Ticket Advice (PTA) is not provided by the principal, Our Company will arrange for tickets for the expatriates through its allied / approved travel agencies.
                                    </li>

                                    <li>
                                        <strong>Orientation: </strong>Orientation is most important factor for adapting the conditions they're going to serve in, in all cases. The concern orients them to maintain understanding and cordiality among themselves, overcoming barriers of nationality, language and culture and above all, to abide the law of the land of their employment. It orients them to maintain a good employee-employer relation under any circumstance. They are motivated to mind their duties above everything and that a better performance only would bring them the envisaged benefit.
                                    </li>

                                    <li>
                                        <strong>Replacement: </strong>Any person technically found unfit within one month from the date of arrival, will be replaced free of all charges as per contract including air ticket if already paid by clients or the amount involved will be refunded to the clients if the Visa is not available or will be adjusted against our account with employers. This replacement is not applicable in case where the selection of workers is made by the employers. Hence we don't stand for any technical guarantee.
                                    </li>
                                    
                                </ul>
                               
                                <p class="my-5">
                                    To view the above documents Please make a contact to us <a href="#">here</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="main__left">
                        <div class="main__left--single">
                            <div class="main__left--head">
                                <ul>
                                    <li><a href="#">Documentation</a></li>
                                    <li><a href="#">Recruitment Process</a> </li>
                                    <li><a href="#">Deployment Procedure</a></li>
                                    <li class="active"><a href="#">Visa Processing</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="main__left--single">
                            <div class="clients-testi">
                                <div class="text-center single-review">
                                For furthery query or suggestion you can contact us
                                    <br>
                                    <br>
                                    <a href="#" class="down-btn">Contact us</a>
                                </div>
                            </div>
                        </div>
                    </div>
